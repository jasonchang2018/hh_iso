create or replace procedure
    edwprodhh.iso.update_claimant_match_return_vehicle()
returns     boolean
language    sql
as
begin
    ...
    (
        ...
        LICENSE_PLATE_STATE,
        LAST_YEAR_REGISTERED,
        MORE_MATCH_INDICATOR_2,
        ANTI_THEFT_DEVICE_TYPE,
        POINT_OF_IMPACT,
        DRIVER_AIRBAG_STATUS,
        PASSENGER_AIRBAG_STATUS,
        LEFT_SIDE_AIRBAG_STATUS,
        RIGHT_SIDE_AIRBAG_STATUS,
        THEFT_TYPE_INDICATOR,
        CLAIM_STATUS,
        SUIT_INDICATOR,
        SETTLEMENT_AMOUNT,
        DATE_CLAIM_CLOSED,
